...
/**
 * @author zhangzhenyu
 * @date 2021/2/24 上午4:16
 * use code from: https://www.jianshu.com/p/d063761ebb9e
 */
public class LocationUtils {

    String TAG = "IrvineTaste.LocationUtils";
    ...
    private void getLocation(){
        ...
        System.out.println("the number of providers = " + providers.size());
